...
# Printing recomendations according to age of user.
    ...
    print('Введенные данные не могут быть обработаны. Пожалуйста, проверьте их корректность (введите возраст в промежутке от 15 до 80 лет,\
 пол прописными русскими буквами целиком).')
